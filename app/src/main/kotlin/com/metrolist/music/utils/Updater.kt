...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/Swelo-ui/SurWave_2"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Metrolist.apk" || name == "SurWave.apk" -> "universal" to "foss"
                name == "Metrolist-with-Google-Cast.apk" || name == "SurWave-with-Google-Cast.apk" -> "universal" to "gms"
